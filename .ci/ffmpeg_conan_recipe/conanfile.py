...
class FFMpegConan(ConanFile):
    ...
    def _configure_autotools(self):
        ...
        args = [
            ...
            opt_enable_disable("mediacodec", self.settings.os == "Android"),
            opt_enable_disable("jni", self.settings.os == "Android"),
            ...
            opt_enable_disable("amf", self.options.with_amf)
        ]
        ...
        if tools.get_env("STRIP") and self.settings.os == "Android":
        ...
        if cross_building(self):
            ...
            elif self._target_os == "androideabi":
